...
<model name="InverseKinematicsAndMotorDriver">
  ...
  <edition>
    <properties>
      ...
      <property name="lastmodifieddate" value="11/26/20 00:54:18"/>
  ...
  <finalization/>
  <diagram>
    <block name="ReadSerial" type="block">
      <template name="85db5678-d578-4c62-a87a-cebcc4065f4f/ReadSerial"/>
      <properties>
      ...
      <graphics>
        ...
        <position x="-463.0333251953125" y="-98.5"/>
      ...
      <diagram>
        <block name="X" type="regular_in_port">
          ...
          <graphics>
            ...
            <background color="255,255,255,255"/>
            <position x="-143" y="-353.4035949707031"/>
        ...
        <block name="Y" type="regular_in_port">
          ...
          <graphics>
            ...
            <frame shape="pentagon" visible="1" color="0,0,0,255" cornerradius="0" thickness="1.5"/>
            <background color="255,255,255,255"/>
            <position x="-144" y="-279.4035949707031"/>
            <size width="20" height="20"/>
            <rotate angle="0"/>
            <texts>
        ...
        <block name="Z" type="regular_in_port">
          ...
          <graphics>
            ...
            <frame shape="pentagon" visible="1" color="0,0,0,255" cornerradius="0" thickness="1.5"/>
            <background color="255,255,255,255"/>
            <position x="-143" y="-203.40359497070313"/>
            <size width="20" height="20"/>
            <rotate angle="0"/>
            <texts>
        ...
        <block name="Theta2" type="regular_out_port">
          ...
          <graphics>
            ...
            <frame shape="pentagon" visible="1" color="0,0,0,255" cornerradius="0" thickness="1.5"/>
            <background color="255,255,255,255"/>
            <position x="194" y="-279.4035949707031"/>
            <size width="20" height="20"/>
            <rotate angle="0"/>
            <texts>
              <text name="text1" color="0,0,0,255" clip="1" x="0.35" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">2</text>
        ...
        <block name="Theta3" type="regular_out_port">
          ...
          <graphics>
            ...
            <frame shape="pentagon" visible="1" color="0,0,0,255" cornerradius="0" thickness="1.5"/>
            <background color="255,255,255,255"/>
            <position x="194" y="-203.40359497070313"/>
            <size width="20" height="20"/>
            <rotate angle="0"/>
            <texts>
              <text name="text1" color="0,0,0,255" clip="1" x="0.35" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">3</text>
    ...
    <block name="Deserialize" type="block">
      <template name="85db5678-d578-4c62-a87a-cebcc4065f4f/Deserialize"/>
      <properties>
        <property name="masked" value="1"/>
        <property name="inlinable" value="0"/>
        <property name="atomic" value="0"/>
    ...
    <block name="SetMotors" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="117.4290771484375" y="-134.5"/>
    ...
    <link name="" type="explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Deserialize" port="1" iotype="in"/>
      <to block="ReadSerial" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="InverseKinematics" port="1" iotype="in"/>
      <to block="Deserialize" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-266" y="-136.5"/>
        <point x="-266" y="-88.5"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="InverseKinematics" port="2" iotype="in"/>
      <to block="Deserialize" port="2" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="InverseKinematics" port="3" iotype="in"/>
      <to block="Deserialize" port="3" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-266" y="-0.5000000000000282"/>
        <point x="-266" y="-48.5"/>
      </points>
    </link>
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="65.130615234375" y="-112.5"/>
        <point x="65.130615234375" y="-136.5"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="63.16232299804688" y="-24.50000000000003"/>
        <point x="63.16232299804686" y="-0.5000000000000284"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <annotation name="Annotation" type="text">
      ...
      <position x="-521.0159606933594" y="-11.811874389648438"/>
      <size width="212" height="28"/>
      <rotate angle="0"/>
      <text font="Arial,10" color="0,0,0,255">NOTE: Make sure COM port is correct</text>
    </annotation>
    <context/>
    <graphics>
      <viewport width="800" height="800" topleftx="0" toplefty="0"/>
