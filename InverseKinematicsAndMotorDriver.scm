...
<model name="InverseKinematicsAndMotorDriver">
  ...
  <initialization>%%Physical Dimensios of Delta Robot (mm)&#xA;f = 230.59 %[mm] Side of the base plate triangle&#xA;e_t = 112.96  %[mm] Side of the traveling plate triangle&#xA;r_f = 64.2 %[mm] Length of upper arm&#xA;r_e = 200  %[mm] Length of the lower arm&#xA;</initialization>
  <finalization/>
  <diagram>
    ...
    <link name="" type="explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ReadSerial" port="1" iotype="out"/>
      <to block="Deserialize" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
